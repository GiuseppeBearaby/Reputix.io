# INCOLLA TUTTO QUESTO IN POWERSHELL
# Devi essere in: C:\Users\Giuseppe\Documents\Reputix.io\Reputix.io\web

cd C:\Users\Giuseppe\Documents\Reputix.io\Reputix.io\web
...
'@ | Set-Content -Path "lib\supabase.ts" -Encoding UTF8

Write-Host "supabase.ts creato" -ForegroundColor Green

# 4. Crea app/dashboard/page.tsx
@'
"use client";
...
Write-Host "dashboard page.tsx creato" -ForegroundColor Green

# 5. Build test
Write-Host "`nRunning build..." -ForegroundColor Cyan
npm run build

Write-Host "`nFatto! Ora torna nella root e pusha:" -ForegroundColor Green
Write-Host "cd .." -ForegroundColor Yellow
Write-Host "git add ." -ForegroundColor Yellow
Write-Host "git commit -m 'add dashboard page'" -ForegroundColor Yellow
